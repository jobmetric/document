---
sidebar_position: 2
sidebar_label: MultiTranslationArrayRequest
---
...
## When to Use MultiTranslationArrayRequest

**Use `MultiTranslationArrayRequest` when you need:**

- **Multi-locale validation**: Validate translations for all active locales from `Language::all()`
- **Automatic locale detection**: Automatically generates rules for all available locales
- **Array-based structure**: Your translation payload uses a simple array format
- **Primary field uniqueness**: Enforces uniqueness for a primary field across all locales
- **Wildcard field support**: Works with models that allow all fields (`['*']`) or specific fields
- **Comprehensive validation**: Validates all locales at once, ensuring complete translation coverage

**Example scenarios:**
- E-commerce product forms requiring translations for all active languages
- CMS content management with mandatory translations for all locales
- Multi-language blog post creation with validation for all supported languages
- Category management forms that require translations in all active locales
- Content forms where all locales must be provided and validated together
...
- [TranslationArrayRequest](/packages/laravel-translation/deep-diving/requests/translation-array-request) - Simpler version for single or dynamic locales
...
- [TranslationTypeObjectRequest](/packages/laravel-translation/deep-diving/requests/translation-type-object-request) - Typeify-based validation for complex schemas
