---
sidebar_position: 2
sidebar_label: TranslationCollectionResource
---
...
**Use `TranslationCollectionResource` when you need:**

- **Model translation serialization**: Return all translations for a model in API responses
- **Locale-specific output**: Filter translations by specific locale
- **Field filtering**: Return only specific translation fields
- **Version history**: Include historical translation versions in responses
- **Multi-locale responses**: Return translations for multiple locales in structured format
- **Translation management APIs**: Build APIs for managing model translations
- **Flexible output shaping**: Control what translation data is included in responses

**Example scenarios:**
- API endpoints returning all translations for a product, post, or category
- Translation management interfaces showing all locales and fields
- Multi-language content APIs with locale filtering
- Translation history views showing version information
- Admin panels displaying all translations for a model
- Content APIs with field-specific translation filtering
...
- [TranslationTypeObjectRequest](/packages/laravel-translation/deep-diving/requests/translation-type-object-request) - Typeify-based form request
